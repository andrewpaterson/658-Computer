...
int main(void)
{
	EmulationModeInterrupts		emi = { 0xfff4, 0xfff6, 0xfff8, 0xfffa, 0xfffc, 0xfffe };
	NativeModeInterrupts		nmi = { 0xffe4, 0xffe6, 0xffe8, 0xffea, 0xfffc, 0xffee };
	SystemBus					systemBus;
	MemoryDevice				memory(128 KB);
	...
	Cpu65816	cpu(systemBus, &emi, &nmi);
	cpu.setRESPin(false);
