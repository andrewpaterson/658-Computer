...
public abstract class NonTraceView<PROPERTIES extends ComponentProperties>
    extends ComponentView
{
  ...
  public NonTraceView(CircuitEditor circuitEditor, Int2D position, Rotation rotation, PROPERTIES properties)
  {
  ...
  public abstract NonTraceData save(boolean selected);
