...
public class CircuitEditor
{
  ...
  public void setCurrentSubcircuitSimulation(SubcircuitEditor newSubcircuitEditor, SubcircuitSimulation newSubcircuitSimulation)
  {
  ...
  public String gotoSubcircuit(SubcircuitEditor newSubcircuitEditor)
  {
    ...
    setSubcircuitSimulationForSubcircuitEditor(newSubcircuitEditor, lastSubcircuitSimulation);
  ...
  {
    setCurrentSubcircuitSimulation(newSubcircuitEditor, instanceSimulation);
    return setCurrentSubcircuitEditor(newSubcircuitEditor);
  }
  ...
  public void addNewSubcircuit(String subcircuitName)
  {
    ...
    UpdatedCircuitInstanceViewPaths updatedPaths = viewPathsUpdate();
    subcircuitView.pathsUpdated(updatedPaths);
  }

  public UpdatedCircuitInstanceViewPaths viewPathsUpdate()
  {
    CircuitInstanceViewPaths newViewPaths = new CircuitInstanceViewPaths(getSubcircuitEditors());

    Map<CircuitInstanceViewPath, CircuitInstanceViewPath> newToExistingPaths = createNewPathToExistingPathMap(newViewPaths);

    UpdatedCircuitInstanceViewPaths updatedCircuitInstanceViewPaths = updateViewPaths(newViewPaths);

    updatePathsLinks(newToExistingPaths);

    validatePathLinks();

    return updatedCircuitInstanceViewPaths;
  }
  ...
  protected UpdatedCircuitInstanceViewPaths updateViewPaths(CircuitInstanceViewPaths newViewPaths)
  {
    ...
    return new UpdatedCircuitInstanceViewPaths(newPaths, removedPaths);
  }
  ...
  public SubcircuitTopSimulation addNewSimulation(String simulationName)
  {
    ...
    return subcircuitEditor.getInstanceSubcircuitView().addNewSimulation(simulationName);
  }
  ...
  public boolean navigateBackwardSubcircuit()
  {
    ...
    if (pair != null)
    {
      setCurrentSubcircuitSimulation(pair.subcircuitEditor, pair.subcircuitSimulation);
