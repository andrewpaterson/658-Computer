    ...
    extends InputDialog
{
  ...
  {
    super(owner, "Select Simulation", true, new Dimension(880, SMALL_HEIGHT), editor);
  }
  ...
  public void build()
  {
    ...
    List<? extends SubcircuitSimulation> simulations = currentSubcircuitEditor.getSubcircuitSimulations();
