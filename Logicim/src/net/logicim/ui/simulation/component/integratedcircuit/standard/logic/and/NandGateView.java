    ...
    extends BaseAndGateView<NandGate>
{
  ...
  @Override
  protected NandGate createIntegratedCircuit(CircuitSimulation simulation, FamilyVoltageConfiguration familyVoltageConfiguration)
  {
    return new NandGate(simulation.getCircuit(),
                        properties.name,
