    ...
    extends BaseOrGateView<OrGate>
{
  ...
  @Override
  protected OrGate createIntegratedCircuit(CircuitSimulation simulation, FamilyVoltageConfiguration familyVoltageConfiguration)
  {
    return new OrGate(simulation.getCircuit(),
                      properties.name,
