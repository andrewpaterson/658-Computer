...
import net.logisim.integratedcircuits.nexperia.lvc157.LVC1G157Factory;
...
import net.logisim.integratedcircuits.onsemi.vhc139.VHC139Factory;
    ...
    extends Library
{
  ...
  public Components()
  {
    try
    {
      ...
      tools.add(new AddTool(VHC139Factory.create()));
      ...
      tools.add(new AddTool(LVC1G157Factory.create()));
