...
{
  private static void print(WDC65C816TickablePins pins, BusCycle busCycle, Instruction instruction)
  {
  ...
  public static void main(String[] args)
  {
    ...
    WDC65C816TickablePins cpuPins = new WDC65C816TickablePins(tickables,
                                                              "",
                                                              addressBus,
                                                              dataBus,
                                                              rwbTrace,
