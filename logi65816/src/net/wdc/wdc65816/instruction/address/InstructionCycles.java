...
import net.wdc.wdc65816.instruction.operations.*;
...
public class InstructionCycles
{
  ...
  protected static ExecuteIf16Bit E16Bit(Executor<WDC65816> consumer, WidthFromRegister width)
  {

    return new ExecuteIf16Bit(consumer, width);
  }

  protected static ExecuteIf8Bit E8Bit(Executor<WDC65816> consumer, WidthFromRegister width)
  {
    return new ExecuteIf8Bit(consumer, width);
  }

  protected static Execute E(Executor<WDC65816> consumer)
  {
