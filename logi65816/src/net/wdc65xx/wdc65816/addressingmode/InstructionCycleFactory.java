...
import static net.wdc65xx.wdc65816.AddressingMode.*;
import static net.wdc65xx.wdc65816.WidthFromRegister.M;
import static net.wdc65xx.wdc65816.addressingmode.InstructionCycles.OpCode;
import static net.wdc65xx.wdc65816.addressingmode.InstructionCycles.*;
...
public class InstructionCycleFactory
{
  ...
  public static InstructionCycles createStackImpliedPHDCycles(Executor<Cpu65816> operation)
  {
    //22c
    return new InstructionCycles(Stack,
                                 new BusCycle(Address(PBR(), PC()), OpCode(), PC_inc()),
