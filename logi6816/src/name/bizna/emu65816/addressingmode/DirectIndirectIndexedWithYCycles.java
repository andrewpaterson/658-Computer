    ...
    extends InstructionCycles
{
  public DirectPageIndirectIndexedWithYCycles(boolean read)
  {
    super(DirectPageIndirectIndexedWithY,
          ...
          new BusCycle(new DataBank(), new AbsoluteOffset(), new YIndex(), new ExecuteLow(true, read)),
          new BusCycle(new DataBank(), new AbsoluteOffset(), new YIndex(), new Offset(1), new ExecuteLow(true, read)));
  }
}
