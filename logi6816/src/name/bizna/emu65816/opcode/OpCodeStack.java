...
public class OpCodeStack extends OpCode
{
  public OpCodeStack(String mName, byte mCode, AddressingMode mAddressingMode)
  {
  ...
  switch (opCode.getCode()) {
    ...
    case(0x68):                 // PLA
    {
      if (accumulatorIs8BitWide()) {
        ...
        mCpuStatus.updateSignAndZeroFlagFrom8BitValue((uint8_t)mA);
        addToProgramAddressAndCycles(1, 4);
      } else {
        mA = mStack.pull16Bit();
