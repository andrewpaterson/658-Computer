...
public class W65C816CoreState
    extends W65C816
    implements InstanceData,
               Cloneable
{
  public W65C816CoreState(Logi65816 parent)
  {
    super(parent);
  }

  public static W65C816CoreState get(InstanceState state, Logi65816 parent)
  {
    W65C816CoreState ret = (W65C816CoreState) state.getData();
    if (ret == null)
    {
      ret = new W65C816CoreState(parent);
      state.setData(ret);
    }
    return ret;
  }
