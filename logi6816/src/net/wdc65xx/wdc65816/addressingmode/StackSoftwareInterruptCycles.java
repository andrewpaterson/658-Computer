...
import static net.wdc65xx.wdc65816.AddressingMode.StackInterruptSoftware;

public class StackSoftwareInterruptCycles
    extends InstructionCycles
{
  //22j
  public StackSoftwareInterruptCycles(InterruptVector interruptVector, Executor<Cpu65816> operation)
  {
